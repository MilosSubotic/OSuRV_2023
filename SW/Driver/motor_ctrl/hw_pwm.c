...
#define PINMUX_GPIO_PIN0 12
#define PINMUX_GPIO_PIN1 13
#define PINMUX_GPIO_ALT_FUN GPIO__ALT_FUN_0
...
int hw_pwm__init(void) {
	...
	//TODO Pinmux alt fun
	gpio__steer_pinmux(PINMUX_GPIO_PIN0, PINMUX_GPIO_ALT_FUN);
	gpio__steer_pinmux(PINMUX_GPIO_PIN1, PINMUX_GPIO_ALT_FUN);
...
void hw_pwm__exit(void) {
	if(virt_pwm_base){
		...
		gpio__steer_pinmux(PINMUX_GPIO_PIN0, GPIO__ALT_FUN_0);
		gpio__steer_pinmux(PINMUX_GPIO_PIN1, GPIO__ALT_FUN_0);
